...
class AdjustFrame(Toplevel):
    ...
    def __init__(self, master=None):
        ...
        self.brightness_label = Label(self, text="Brightness", font="cambria 12 italic", bg="#00C5CD")
        self.brightness_scale = Scale(self, from_=0, to_=2, length=250, resolution=0.1,
                                      orient=HORIZONTAL, bg="#afeeee")
        self.r_label = Label(self, text="R", font="cambria 12 italic", bg="#00C5CD")
        self.r_scale = Scale(self, from_=-100, to_=100, length=250, resolution=1,
                             orient=HORIZONTAL, bg="#afeeee")
        self.g_label = Label(self, text="G", font="cambria 12 italic", bg="#00C5CD")
        self.g_scale = Scale(self, from_=-100, to_=100, length=250, resolution=1,
                             orient=HORIZONTAL, bg="#afeeee")
        self.b_label = Label(self, text="B", font="cambria 12 italic", bg="#00C5CD")
        self.b_scale = Scale(self, from_=-100, to_=100, length=250, resolution=1,
                             orient=HORIZONTAL, bg="#afeeee")
        self.apply_button = Button(self, text="Apply", font="cambria 12 italic", bg="#afeeee")
        self.preview_button = Button(self, text="Preview", font="cambria 12 italic", bg="#afeeee")
        self.cancel_button = Button(self, text="Cancel", font="cambria 12 italic", bg="#afeeee")
