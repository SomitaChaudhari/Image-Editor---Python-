from tkinter import Frame, Canvas, CENTER, ROUND, PhotoImage, Label, colorchooser
...
class ImageViewer(Frame):
    ...
    def __init__(self, master=None):
        Frame.__init__(self, master=master,bg="#00C5CD",width=1920, height=1080)
        ...
        self.canvas = Canvas(self,bg="#afeeee", width=951, height=536)
    ...
    def draw(self, event):
        ...
        self.draw_ids.append(self.canvas.create_line(self.x, self.y, event.x, event.y, width=4,
