...
class FilterFrame(Toplevel):
    ...
    def __init__(self, master=None):
        Toplevel.__init__(self, master=master, bg="#00C5CD")

        self.original_image = self.master.processed_image
        self.filtered_image = None

        self.negative_button = Button(master=self, text="Negative",font="cambria 12 italic", bg="#afeeee")
        self.black_white_button = Button(master=self, text="Black White", font="cambria 12 italic", bg="#afeeee")
        self.sepia_button = Button(master=self, text="Sepia",font="cambria 12 italic", bg="#afeeee")
        self.emboss_button = Button(master=self, text="Emboss", font="cambria 12 italic", bg="#afeeee")
        self.gaussian_blur_button = Button(master=self, text="Gaussian Blur", font="cambria 12 italic", bg="#afeeee")
        self.median_blur_button = Button(master=self, text="Median Blur", font="cambria 12 italic", bg="#afeeee")
        self.cancel_button = Button(master=self, text="Cancel", font="cambria 12 italic", bg="#afeeee")
        self.apply_button = Button(master=self, text="Apply", font="cambria 12 italic", bg="#afeeee")
