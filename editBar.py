...
class EditBar(Frame):
    ...
    def __init__(self, master=None):
        ...
        self.new_button = Button(self, text="NEW", font="cambria 14 bold italic", bg="#afeeee", padx =5)
        self.save_button = Button(self, text="SAVE", font="cambria 14 bold italic", bg="#afeeee", padx=5)
        self.save_as_button = Button(self, text="SAVE AS", font="cambria 14 bold italic", bg="#afeeee", padx=5)
        self.draw_button = Button(self, text="DRAW", font="cambria 14 bold italic", bg="#afeeee", padx=5)
        self.crop_button = Button(self, text="CROP", font="cambria 14 bold italic", bg="#afeeee", padx=5)
        self.filter_button = Button(self, text="FILTER", font="cambria 14 bold italic", bg="#afeeee", padx=5)
        self.adjust_button = Button(self, text="ADJUST", font="cambria 14 bold italic",bg="#afeeee", padx=5)
        self.clear_button = Button(self, text="CLEAR", font="cambria 14 bold italic",bg="#afeeee", padx=5)
